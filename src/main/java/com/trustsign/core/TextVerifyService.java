...
/**
 * Verifies text signatures in the custom format using SHA256withRSA only:
 *
 * <original text>
 * <START-SIGNATURE>base64(raw SHA256withRSA signature)</START-SIGNATURE>
...
public final class TextVerifyService {
   ...
   * on the content before the signature block to tolerate editor differences.
   */
